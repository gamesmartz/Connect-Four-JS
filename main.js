...
function clickHandler() {
  // $('.col0').on('click', dropCoin);
  // $('.col1').on('click', dropCoin);
  // $('.col2').on('click', dropCoin);
  // $('.col3').on('click', dropCoin);
  // $('.col4').on('click', dropCoin);
  // $('.col5').on('click', dropCoin);
  // $('.col6').on('click', dropCoin);
